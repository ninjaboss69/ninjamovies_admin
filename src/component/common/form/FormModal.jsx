    ...
    return (
        <AnimatePresence>
            {isOpen && (
                ...
                >
                    <motion.div
                        className="bg-white rounded-2xl shadow-lg p-6 w-full max-w-[60%] max-h-[80%] flex flex-col"
                    ...
                    >
                        ...
                        <div className="flex items-start justify-between mb-4">
                            ...
                            <span
                                className="text-sm font-bold cursor-pointer border border-slate-600 px-2 py-1 rounded-md hover:bg-gray-300 transition"
                                onClick={onClose}
                            >
                                X
                            </span>
