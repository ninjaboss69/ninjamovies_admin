...
import PreviewForm from '../../component/preview/PreviewForm';
import PreviewList from '../../component/preview/list/PreviewList';
const Preview = () => {
    const defaultData = {
        publish: false,
        imagefile: "",
    ...
    const { data, error, loading, fetchData } = useFetchData(`/backpanel/previews`);
    ...
    const savePost = async (postData, id) => {
        ...
        if (id) {
            await instanceForMultipart
                .put(`/backpanel/previews/${id}`, formData)
                .then((res) => {
            ...
            await instanceForMultipart
                .post(`/backpanel/previews`, formData)
                .then((res) => {
